//分类查找后分页
function searchdividepage(pagenow,category){
	var pagesize;
	 $.ajax({
         type: "GET",
         url: "/bookEX/shop/categorysearch",
         data: {pagenow:pagenow,booktype:category},
         dataType: "json",
        			  ...
        			  for(var i=0;i<books.length;i++)
						...
						"</div>" ;       				  
        				  ...
        				  if(page.pagenow==1)
  							...
  							resultpage+="<li><a onclick='searchdividepage("+(page.pagenow-1)+","+type+")'style='text-decoration: none;cursor:pointer;'>&laquo;</a></li>";
        					  }
        				  for(var i=0;i<page.pagecount;i++)
        					  {
        					  resultpage+="<li><a onclick='searchdividepage("+(i+1)+","+type+")' style='text-decoration: none;cursor:pointer;'>"+(i+1)+"</a></li>";
        					  };
        				if(page.pagenow==page.pagecount)
        					...
        					resultpage+="<li><a>&raquo;</a></li>";
        						...
        						{
        						resultpage+="<li><a onclick='searchdividepage("+(page.pagenow+1)+","+type+")'style='text-decoration: none;cursor:pointer;'>&raquo;</a></li>";
        						}
        				resultpage+="</ul>";
